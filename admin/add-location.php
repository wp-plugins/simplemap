...
<div class="wrap">
	...
	<?php wp_nonce_field('update-options'); ?>
		...
		<tr valign="top">
			<th scope="row"><label for="store_name"><?php _e('Name', 'SimpleMap'); ?></label></th>
			<td><input type="text" name="store_name" id="store_name" size="27" value="" /></td>
		</tr>
		 
		<tr valign="top">
			<th scope="row"><label for="store_address"><?php _e('Address', 'SimpleMap'); ?></label></th>
		...
		<tr valign="top">
			<th scope="row"><label for="store_city"><?php _e('City, State, Zip', 'SimpleMap'); ?></label></th>
		...
		<tr valign="top">
			<th scope="row"><label for="store_phone1"><?php _e('Phone', 'SimpleMap'); ?></label></th>
		...
		<tr valign="top">
			<th scope="row"><label for="store_fax1"><?php _e('Fax', 'SimpleMap'); ?></label></th>
		...
		<tr valign="top">
			...
			<br /><?php _e('Please include the', 'SimpleMap'); ?> <strong>http://</strong></td>
		</tr>
