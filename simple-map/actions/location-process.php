			...
			?>
				<tr id='post-<?php echo $bcl_store_id; ?>' class='<?php echo $bcl_altclass; ?>author-self status-publish iedit' valign="top">
					...
					<td class="post-title column-title"><strong><span class="row-title row_name"><?php echo $bcl_store_name; ?></span></strong>
						...
						<span class='delete'><a class='submitdelete' title='Delete this location' href='../wp-content/plugins/simple-map/actions/location-process?action=delete&amp;del_id=<?php echo $bcl_store_id; ?>' onclick="javascript:return confirm('Do you really want to delete \'<?php echo addslashes($bcl_store_name); ?>\'?');">Delete</a></span>
					</div>
