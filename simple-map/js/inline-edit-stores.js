...
//		$('fieldset.inline-edit-col-bottom').prepend(
	...
	edit : function(id) {
		...
		var fields = ['store_id', 'altclass', 'store_name', 'store_address', 'store_address2', 'store_city', 'store_state', 'store_zip', 'store_phone1', 'store_phone2', 'store_phone3', 'store_fax1', 'store_fax2', 'store_fax3', 'store_url', 'store_special'];
	...
	save : function(id) {
		...
		$.post('../wp-content/plugins/simple-map/actions/location-process.php', params,
			function(r) {
		...
		/*
var fields0 = ['store_id', 'store_name', 'store_address', 'store_address2', 'store_city', 'store_state', 'store_zip', 'store_phone1', 'store_phone2', 'store_phone3', 'store_fax1', 'store_fax2', 'store_fax3', 'store_url', 'store_special'];
		
		var rowData = $('#inline_'+id);
		var visibleData = $('#post-'+id);
		var editRow = $('#inline-edit');
		
		for ( var f = 0; f < fields0.length; f++ ) {
			var spanName = fields0[f].substr(6);
			alert ($(':input[name="'+fields0[f]+'"]', editRow).val());
			$('.'+fields0[f], rowData).text( $(':input[name="'+fields0[f]+'"]', editRow).val() );
			$('.'+spanName, visibleData).text( $(':input[name="'+fields0[f]+'"]', editRow).val() );
		}
		
		$.post('../wp-content/plugins/a_better_store_locator/bcLocator-edit.php', params);
